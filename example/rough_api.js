function Game() {
    ...
    obj1.addComponent( 'spatial', new Paladin.components.Spatial() );
    obj1.addComponent( 'model', new Paladin.components.Model( mesh ) );
    obj1.setParent( render );

    var obj2 = new Paladin.Entity();
    obj2.addComponent( 'spatial', new Paladin.components.Spatial() );
    obj2.addComponent( 'model', new Paladin.components.Model( mesh ) );
